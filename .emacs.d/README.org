...
CLOSED: [2024-04-10 Wed 15:27]

There is an issue in the order of loading this package and the theme.
...
#+BEGIN_SRC emacs-lisp
    ...
    (defun jf/org-setup-task-management-and-agenda ()
      ...
      ;; see README, Troubleshooting section https://gitlab.com/hperrey/khalel
...
#+begin_src emacs-lisp
  (use-package mu4e
    ...
    ;; (mu4e-icalendar-setup) ; obsolete since 1.11.22
    ;; gnus / mu4e
    ;; icalendar -> org sync
