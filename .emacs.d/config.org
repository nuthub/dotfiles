  ...
  (use-package org
    ...
    (setq org-capture-templates
          '(
            ...
            ("e" "Event" entry (file "~/org/inbox.org")           "* %^{Event Title}\n\n%^{Date and Time}T\nLocation: %^{Location}\n%i%?" :time-prompt t)
  ...
  (when (string= (system-name) "nutbook")
    (use-package org-caldav
      ...
      (setq org-caldav-calendars
            '((:calendar-id "org-2"
                            :files ("~/org/events.org" "~/org/events-inbox.org")
                            :inbox "~/org/events-inbox.org")))
      ;; (:calendar-id "personal"
      ;;                         :files ("~/org/events-personal.org" "~/org/events-personal-inbox.org")
      ;;                         :inbox "~/org/events-personal-inbox.org")
