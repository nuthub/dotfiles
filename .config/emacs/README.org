  ...
  (use-package mu4e
    ...
    (setq mu4e-bookmarks
          '((:name "Combined inbox" :query "maildir:/private/INBOX OR maildir:/work/INBOX OR maildir:/tudo/INBOX" :key ?i)
            ...
            (:name "Archives" :query "maildir:/private/Archives OR maildir:/work/Archives" :key ?a)
            ...
            (:name "Guix Mailing Lists" :query "maildir:/private/INBOX/Guix-Lists" :key ?g)
            (:name "Emacs Mailing Lists" :query "maildir:/private/INBOX/Emacs-Lists" :key ?e)
            (:name "FSInfo Mailing Lists" :query "maildir:/private/INBOX/FSInfo" :key ?f)
