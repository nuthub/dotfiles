...
(home-environment
 (packages (specifications->packages
	     ...
	     "emacs-vertico" "emacs-orderless" "emacs-consult" "emacs-corfu" "emacs-marginalia" "emacs-embark" "emacs-vundo" "emacs-aggressive-indent" "emacs-openwith" "emacs-frames-only-mode" "emacs-terminal-here"
	     ...
	     "emacs-magit" "emacs-forgejo" "emacs-git-gutter" "emacs-git-gutter-fringe" 
	     "emacs-all-the-icons" "emacs-all-the-icons-dired" "emacs-all-the-icons-completion"
	     "emacs-olivetti" "emacs-gt" "emacs-jinx" "enchant"
